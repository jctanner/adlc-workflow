---
name: adlc-feature-refine-worker
...
`RHAIRFE-*` Jira key. Return the complete strategy markdown to the calling
workflow.
...
5. Return that markdown to the parent workflow so it can build and submit the
   result envelope.
